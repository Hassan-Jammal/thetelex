<template>
  <div class="min-h-screen bg-white">
    ...
    <main class="max-w-[1300px] mx-auto px-4 py-8">
      <div class="grid lg:grid-cols-[1fr_300px] gap-8">
        <!-- Main content -->
        <div>
          <!-- Breaking news banner -->
          <div class="bg-[var(--guardian-blue)] text-white px-6 py-3 mb-6 flex items-center gap-3 hover:bg-opacity-90 transition-all">
            <span class="text-[var(--guardian-yellow)] text-xl animate-pulse">
              ●
            </span>
            ...
            <a
              href="#"
              class="ml-1 transition-all flex-1 hover:!text-[var(--guardian-yellow)]"
            >
              Major developments unfold in global climate summit
            </a>
            <span class="text-xs opacity-75">LIVE</span>
          </div>
